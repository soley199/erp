...
<header class="topbar" data-navbarbg="skin5">
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header" data-logobg="skin5">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <a class="navbar-brand" href="arb_inicio">
              <!-- Logo icon -->
              <b class="logo-icon ps-2">
                <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                <!-- Dark Logo icon -->
                <img
                  src="views/assets/images/icon-logo.png"
                  alt="Canabrake"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="views/assets/images/text-logo.png"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
              ...
              <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
              <!-- Dark Logo icon -->
              <!-- <img src="views/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="views/assets/images/users/default.jpg"
                    alt="user"
                ...
                >
                  ...
                  <a class="dropdown-item" href="arb_salir"
                    ><i class="fa fa-power-off me-1 ms-1"></i> Salir sistema</a
                  >
                  <div class="dropdown-divider"></div>
                  <div class="ps-4 p-10">
                    <a
